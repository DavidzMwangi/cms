...
<header>
    ...
    <div class="sidebar-fixed position-fixed">
        ...
        <div class="list-group list-group-flush">
            ...
            <button  name="add_milk" type="submit" class="list-group-item list-group-item-action waves-effect">
               <i class="fa fa-table mr-3"></i>Add Milk Record</button>

            </form>
            <a href="#" class="list-group-item list-group-item-action waves-effect">
                <i class="fa fa-user mr-3"></i>Add Cow</a>
...
<!--        -->
        ...
        if (isset($_POST['add_milk'])){
            require_once 'add_milk_record.php';

//            $sidebar->changeView(2);
        }else{
